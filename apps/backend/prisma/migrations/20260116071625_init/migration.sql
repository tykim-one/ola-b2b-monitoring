...
CREATE TABLE "AnalysisMessage" (
    ...
    "metadata" TEXT,
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "AnalysisMessage_sessionId_fkey" FOREIGN KEY ("sessionId") REFERENCES "AnalysisSession" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
-- CreateIndex
CREATE INDEX "AnalysisMessage_sessionId_idx" ON "AnalysisMessage"("sessionId");
